// ===============================================
// LOGIQUE DE CONSENTEMENT RGPD (NOUVEAUTÉ)
// Cette section doit être exécutée en premier
// ===============================================

(function () {
    const CONSENT_BANNER_ID = "consent-banner";
    const STORAGE_KEY = "user_cookie_consent";
    const TRACKING_ID = "AW-11242044118"; // Google Adwords ID
...
        if (banner) {
            banner.style.display = 'flex'; // Afficher le bandeau
            document.body.classList.add('has-consent-banner'); // Utile pour masquer le scroll
        }
    }
...
            hideBanner();
        } else if (!consent) {
            // Si pas de choix, afficher le bandeau
            showBanner();
        }
...
// ===============================================
// CODE EXISTANT DU FICHIER ADOU.JS (NON MODIFIÉ)
// ===============================================
...
// =========================================
// BLOC D’INJECTION ENVOI SHEETS (NON MODIFIÉ)
// =========================================
(function () {
    "use strict";
